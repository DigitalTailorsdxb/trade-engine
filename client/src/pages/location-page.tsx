...
const testimonials = [
  {
    quote: "We were getting enquiries but losing them to faster competitors. Now we respond in seconds — even on weekends. Our close rate has genuinely improved.",
    name: "James T.",
  ...
  },
  {
    ...
    name: "Sarah M.",
    role: "Garden Design & Landscaping",
  },
];
      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            name: `Trade Engine — ${location.name}`,
              ...
              >
                ...
                <div className="mb-6">
                  ...
                  <div className="text-sm text-slate-500">
                    Setup from <span className="line-through text-slate-400">{tier.setup === "£249" ? "£498" : "£998"}</span>{" "}
                ...
                <div className="mt-auto">
                  {tier.ctaHref.startsWith("http") ? (
                    ...
                    <a
                      href={tier.ctaHref}
                      onClick={(e) => handleNavClick(e, tier.ctaHref)}
