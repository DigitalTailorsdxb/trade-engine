...
const coreFeatures = [
  {
    ...
    description: "Your customers get accurate, professional quotes instantly through an intelligent guided process. Two quote paths available: Full Garden Makeover for complete transformations, or Individual Products for specific items like patios, decking, or fencing. No more waiting days for callbacks - your website captures and converts leads around the clock.",
    highlights: [
      "Simple 6-step guided process customers love",
      ...
      "Fully customisable pricing logic for your business",
  ...
  },
  {
    ...
    tagline: "See the result before committing",
    description: "Customers upload a photo of their current garden and receive an AI-generated photorealistic preview of their new design in just 90 seconds. This powerful feature is completely FREE for your customers, removing all barriers to engagement. Businesses using AI visualisation see conversion rates increase by 40% or more.",
    highlights: [
      "Photo-to-design transformation using latest AI technology",
      "Photorealistic previews delivered in 90 seconds",
      "Sent directly to customer's email inbox",
      "100% FREE for customers - removes hesitation",
      "Increases conversion rates by 40%+ on average",
      "Multiple design variations available per request",
    ],
  },
  {
    icon: Users,
    title: "HubSpot CRM Integration",
    tagline: "All customer data in one place",
    description: "Every lead from your website is automatically captured and synced to HubSpot CRM in real-time. Customer details, quote history, design requests, and all interactions are stored and updated instantly. Set up automated follow-up sequences to nurture leads and never let a potential customer slip through the cracks.",
    highlights: [
      "Automatic lead capture from every form and quote",
      "Real-time sync - data appears in HubSpot instantly",
      "Full customer history and interaction tracking",
  ...
  },
  {
    ...
    description: "Over 70% of your visitors will be on mobile. Your website works flawlessly on phones, tablets, and desktops with lightning-fast loading times and intuitive navigation. Customers can request quotes and AI designs from their sofa, on the train, or anywhere with an internet connection.",
    highlights: [
      "Fully responsive design on all screen sizes",
      "Lightning-fast loading under 3 seconds",
      "Touch-optimised buttons and navigation",
      "Easy hamburger menu for mobile users",
      "No app download required - works in any browser",
      "Customers can get quotes from anywhere, anytime",
    ],
  },
];
