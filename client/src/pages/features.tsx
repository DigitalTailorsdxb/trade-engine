...
const coreFeatures = [
  {
    ...
    description: "Customers get accurate quotes instantly. No waiting around - captures leads 24/7.",
    highlights: [
      "Simple 6-step guided process",
      "Real-time price calculations",
      "Professional branded PDF quotes",
      "Customisable pricing for your business",
    ],
  },
  {
    icon: ImageIcon,
    ...
    description: "Customers upload a photo and receive an AI-generated preview in 90 seconds. Free for customers.",
    highlights: [
      "Photo-to-design in 90 seconds",
  ...
  },
  {
    ...
    description: "Every lead is automatically captured and synced to HubSpot CRM. Customer data updated instantly.",
    highlights: [
      "Automatic lead capture",
      "Real-time data sync to HubSpot",
  ...
  },
  {
    ...
    description: "Works flawlessly on phones, tablets, and desktops. Fast loading and easy navigation.",
    highlights: [
